...
namespace PetHealthCenter.UnitTests
{
    ...
    public class OperatingCardServiceUnitTests
    {
        ...
        public async Task TestGetAllAsyncInMemory()
        {
            ...
            //{
            //    new OperatingCard() { Id = 100, CustomerId = 100, PetId = 100, PartId = 100, ServiceId = 100, ApplicationUserId = Guid.Parse("265f6e7d-6b6e-43e8-b385-19315ca888f9"), IsActive = true, DocumentNumber = "" },
            //    new OperatingCard() { Id = 101, CustomerId = 101, PetId = 101, PartId = 101, ServiceId = 101, ApplicationUserId = Guid.Parse("265f6e7d-6b6e-43e8-b385-19123ca888f9"), IsActive = true, DocumentNumber = "" }
            //});
        ...
        [Test]
        public async Task TestGetHealthServicesAsyncInMemory()
        {
            var loggerMock = new Mock<ILogger<OperatingCardService>>();
            logger = loggerMock.Object;
            var repo = new Repository(applicationDbContext);
            ...
            await applicationDbContext.AddRangeAsync(new List<HealthService>
            {
                new HealthService() { Id = 100, Name = "", Description = ""},
                new HealthService() { Id = 101, Name = "", Description = "" }
            });

            await applicationDbContext.SaveChangesAsync();
            var collection = cardService.GetHealthServicesAsync().Result;
        ...
        [Test]
        public async Task TestGetDoctorsAsyncInMemory()
        {
            var loggerMock = new Mock<ILogger<OperatingCardService>>();
            logger = loggerMock.Object;
            var repo = new Repository(applicationDbContext);
            ...
            {
                new ApplicationUser() { Id = Guid.Parse("65fc2044-7cfb-43fc-8c68-0efa6b6d421a"), Email = "", UserName = "doctor1"},
                new ApplicationUser() { Id = Guid.Parse("65fc2044-929f-4131-a6ef-5d32bd793a21"), Email = "", UserName = "doctor2"}
            });

            await applicationDbContext.SaveChangesAsync();
            var collection = cardService.GetDoctorsAsync().Result;
        ...
        [Test]
        public async Task TestGetCustomerPetsInMemory()
        {
            var loggerMock = new Mock<ILogger<OperatingCardService>>();
            logger = loggerMock.Object;
            var repo = new Repository(applicationDbContext);
            ...
            await applicationDbContext.AddAsync(animal);
            ...
            await applicationDbContext.AddAsync(animal2);
            await applicationDbContext.SaveChangesAsync();

            var collection = await cardService.GetCustomerPets(customer.Id);
        ...
        public async Task TestMarkRepairAsFinishedAsyncInMemory()
        {
            ...
            var user = new ApplicationUser() { Id = Guid.Parse("65fc2044-7cfb-43fc-8c68-0efa6b6d421a"), Email = "", UserName = "doctor1" };
            ...
            var card = new OperatingCard() { Id = 100, CustomerId = 100, PetId = 100, PartId = part.Id, ServiceId = 100, ApplicationUserId = user.Id, IsActive = true, DocumentNumber = "" };

...
using PetHealthCenter.Core.Models.User;
...
namespace Library.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        /// </summary>
        /// <returns>Create Administrator, Doctor and Service-Adviser roles</returns>
        ...
        /// </summary>
        /// <returns>Add administraor, doctor and service-adviser to their roles</returns>
        public async Task<IActionResult> AddUsersToRoles()
        {
            string email1 = "manager_pet_health@mail.com";
            ...
            await userManager.AddToRolesAsync(user, new string[] { RoleConstants.Administrator, RoleConstants.ServiceAdviser, RoleConstants.Doctor });
            await userManager.AddToRolesAsync(user2, new string[] { RoleConstants.ServiceAdviser, RoleConstants.Doctor });
            await userManager.AddToRolesAsync(user3, new string[] { RoleConstants.Doctor });

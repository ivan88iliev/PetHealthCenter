namespace PetHealthCenter.Common.Constants
{
    public static class DbModelCommentConstants
    {
        ...
        {
            public const string OrderMain = "Order of medical products properties";
            ...
            public const string OrderParts = "Collection of ordered medical products";
        ...
        public static class Part
        {
            ...
            public const string PartSupplierMedProducts = "Collection of suppliers, selling the part";
        ...
        public static class HealthService
        {
            ...
            public const string HealthServiceParts = "Collection of medical products needed for the service";
            public const string HealthServiceIsActive = "Property that defines if the service is active";
        }

        public static class Supplier
        {
            public const string SupplierMain = "Supplier, who delivers medical products to the pet health center";
            ...
            public const string SupplierSupplierMedProducts = "Collection of med products, selled by the supplier";
        ...
        {
            public const string ProductComponentMain = "The components/medProducts of the animal, which can be affected by the services";
        ...
        {
            public const string SupplierSparePartMain = "Mapping entity between suppliers and medical products";
        }
    }
}

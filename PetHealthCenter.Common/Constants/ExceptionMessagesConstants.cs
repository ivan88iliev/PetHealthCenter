namespace PetHealthCenter.Common.Constants
{
    public static class ExceptionMessagesConstants
    {
        ...
        public const string InvalidHealthServiceException = "Something went wrong while creating the health service!";
        ...
        public const string InvalidGetPartsException = "Something went wrong while getting all medical products from data-base!";
        ...
        public const string InvalidHealthServiceIdException = "Service with this Id does not exists in data-base!";
        ...
        public const string InvalidGetManufacturersException = "Something went wrong while getting all medical products manufacturer from data-base!";

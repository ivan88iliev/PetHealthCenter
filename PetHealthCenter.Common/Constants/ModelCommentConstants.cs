namespace PetHealthCenter.Common.Constants
{
    public static class ModelCommentConstants
    {
        ...
        public static class OperatingCard
        {
            ...
            public const string AddViewModelParts = "Collection of all medical products in storage, that can be used to perform the services";
        ...
        {
            public const string AddViewModelMain = "Model, used to add newmedical productsto the storage";
        ...
        public static class Statistics
        {
            ...
            public const string ServiceViewModelTotalParts = "Propery for the count of all of the medical products into the storage";
